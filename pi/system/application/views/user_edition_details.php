...
217px; height: 19px;">Editions of  "<?php echo $title;?>" in the Library:</span>
...
<span id="ctl00_MSPlace_Label41" style="color: rgb(0, 51, 0); font-family: Arial Narrow; font-weight: bold; 
text-decoration: underline; z-index: 1; left: 0px; top: 330px; width: 
217px; height: 19px;">Details of Edition NO- <?php echo $edition; ?> :</span>
...
<?php
if ($no_of_available_copy > 0){
	$user_id = $this->session->userdata('user_id');
	//echo $user_id;
	echo anchor("membersArea/user_borrow_book/$id/$edition/$accession/$user_id", 'Borrow a copy'); 
}else{
	echo "You can't Borrow";
}
?>
